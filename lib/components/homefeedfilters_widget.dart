...
import 'homefeedfilters_model.dart';
export 'homefeedfilters_model.dart';

class HomefeedfiltersWidget extends StatefulWidget {
  const HomefeedfiltersWidget({super.key});

  @override
  State<HomefeedfiltersWidget> createState() => _HomefeedfiltersWidgetState();
}

class _HomefeedfiltersWidgetState extends State<HomefeedfiltersWidget> {
  late HomefeedfiltersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomefeedfiltersModel());
